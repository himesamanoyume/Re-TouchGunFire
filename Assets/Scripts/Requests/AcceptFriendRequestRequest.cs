...
public sealed class AcceptFriendRequestRequest : IRequest
{
    public override void Awake()
    {
        Name = "AcceptFriendRequestRequest";
        requestCode = RequestCode.Friend;
        actionCode = ActionCode.AcceptFriendRequest;
        base.Awake();
    }
        ...
        Loom.QueueOnMainThread(()=>{
            switch(mainPack.ReturnCode){
                ...
                case ReturnCode.Fail:
                    // Debug.Log("同意添加好友请求失败");
                    panelMediator.ShowNotifyPanel("同意添加好友请求失败",3f);
                break;
